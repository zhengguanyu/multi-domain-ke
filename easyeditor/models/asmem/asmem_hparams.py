...
@dataclass
class ASMemHyperParams(HyperParams):
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config['alg_name'] == 'ASMem'),\
            f'ASMemHyperParams can not load from {hparams_name_or_path}. alg_name is {config["alg_name"]}'
